...
use vangenplotz\imageshop\fields\ImageshopImage         as ImageshopImageField;
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'imageshop/default';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['cpActionTrigger1'] = 'imageshop/default/do-something';
            }
        );
        ...
        Event::on(
            ...
            function (Event $event) {
                ...
                $variable->set('imageshop', ImageshopVariable::class);
            }
        );
